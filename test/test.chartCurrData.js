...
describe('chartCurrData function tests', function () {
	...
	it("should attempt to get graph dat with an invalid currency code", function (done) {
		var callFunc = async () => {
	...
	it("should attempt to get graph data with invalid currency code (number)", function (done) {
		var callFunc = async () => {
			var currency_code = 1;
			var response = await chartCurrData.getCurrData(currency_code);
			assert.equal(response, false);
	...
	it("should attempt to get graph data with invalid currency code (float)", function (done) {
		var callFunc = async () => {
	...
	it("should attempt to get graph data with invalid currency code (array)", function (done) {
		var callFunc = async () => {
			var currency_code = [];
			var response = await chartCurrData.getCurrData(currency_code);
			assert.equal(response, false);
	...
	it("should attempt to get graph data with invalid currency code (object)", function (done) {
		var callFunc = async () => {
			var currency_code = {};
			var response = await chartCurrData.getCurrData(currency_code);
			assert.equal(response, false);
	...
	it("should attempt to get graph data with valid currency code but get no reply", function (done) {
		var callFunc = async () => {
