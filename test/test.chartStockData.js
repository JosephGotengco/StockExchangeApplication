...
describe('Test chart stock data function (chartStockData) ', function () {
    ...
    it("should attempt to get graph data with an invalid ticker", function (done) {
        var callFunc = async () => {
    ...
    it("should attempt to get graph data with invalid ticker (number)", function (done) {
        var callFunc = async () => {
            var currency_code = 1
            var response = await chartStockData.getStockData(currency_code);
            assert.equal(response, false);
    ...
    it("should attempt to get graph data with invalid ticker (float)", function (done) {
        var callFunc = async () => {
    ...
    it("should attempt to get graph data with invalid ticker (array)", function (done) {
        var callFunc = async () => {
            var currency_code = []
            var response = await chartStockData.getStockData(currency_code);
            assert.equal(response, false);
    ...
    it("should attempt to get graph data with invalid ticker (object)", function (done) {
        var callFunc = async () => {
            var currency_code = {}
            var response = await chartStockData.getStockData(currency_code);
            assert.equal(response, false);
    ...
    it("should attempt to get graph data with valid ticker but get no reply", function (done) {
        var callFunc = async () => {
